...
var order_l_data = localStorage.getItem('order_data');
let order_data;
if (order_l_data) {
     order_data = JSON.parse(order_l_data);
    // console.log('Object found:', order_data);
    // console.log(order_data[0]);
} else {
    console.log('No object found or object has been removed');
}

console.log(order_data);
console.log(order_data[4]);
console.log(typeof order_data[5]);
...
$("#order_id").val(order_data[1])
$("#user_id").val(order_data[2])
$("#order_date").val(order_data[3])
$("#country").val(order_data[4])

$(document).on("change","#country",function (e) { 
  e.preventDefault();
  $("#state").val(order_data[5])
});

$("#city").val(order_data[7])
cat = JSON.parse( order_data[11])[0]["prod_cat"];
